...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 border-b-2 border-gray-700 text-white">
      <div className="flex flex-wrap items-center justify-between lg:container px-4 py-6 mx-auto md:flex-no-wrap md:px-6">
        ...
        <button className="flex items-center block px-3 py-2 text-white border border-white rounded md:hidden" onClick={() => setMobileMenuIsOpen(!mobileMenuIsOpen)}>
